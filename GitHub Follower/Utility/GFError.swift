...
enum GFError: String, Error {
    ...
    case unableToFavorite = "Unable to add this user to favorite. please try agin later."
    case alreadyFavorite = "You have already added this user to yoiur favorites."
}
